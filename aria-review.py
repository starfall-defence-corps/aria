...
MISSION_MAP = {
    ...
    "2-2": {
        "test": "molecule/default/tests/test_compliance.py",
        "student_files": [
            "workspace/obstacle-course/mission-1/site.yml",
            "workspace/obstacle-course/mission-2/site.yml",
            "workspace/main-mission/COMPLIANCE.md",
            "workspace/ansible.cfg",
        ],
    },
    "2-3": {
    ...
    "3-4": {
        "test": "molecule/default/tests/test_eyes_everywhere.py",
        "student_files": [
            "workspace/site.yml",
            "workspace/roles/telemetry/tasks/main.yml",
            "workspace/roles/telemetry/tasks/rsyslog.yml",
            "workspace/roles/telemetry/tasks/audit.yml",
            "workspace/roles/telemetry/tasks/agent.yml",
            "workspace/roles/telemetry/handlers/main.yml",
            "workspace/roles/telemetry/defaults/main.yml",
            "workspace/roles/telemetry/templates/99-sdc-forward.conf.j2",
            "workspace/roles/telemetry/templates/sdc-audit.rules.j2",
            "workspace/roles/telemetry/templates/fleetquery.conf.j2",
            "workspace/inventory/hosts.yml",
            "workspace/inventory/group_vars/all.yml",
            "workspace/ansible.cfg",
        ],
    ...
    if args.output:
        with open(args.output, "w") as f:
            ...
            if review_text:
                ...
                f.write(review_note)
                f.write("\n")
            # The rank/badge block belongs to the local 'make test' success
            # banner — PR review comments never include it (E2E feedback on
            # sdc-academy #119/#123).
